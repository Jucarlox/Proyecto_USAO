class ProfileResponse {
  ...
  late final List<dynamic> productoListLike;
  ...
  ProfileResponse.fromJson(Map<String, dynamic> json) {
    ...
    productoList = List.from(json['productoList'])
        ...
        .toList();
    productoListLike =
        List.castFrom<dynamic, dynamic>(json['productoListLike']);
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    _data['productoListLike'] = productoListLike;
    return _data;
  }
}
...
class ProductoList {
  ...
  late final List<dynamic> idUsersLike;
  ...
  ProductoList.fromJson(Map<String, dynamic> json) {
    ...
    idUsersLike = List.castFrom<dynamic, dynamic>(json['idUsersLike']);
  }
